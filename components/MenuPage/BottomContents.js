...
const BottomContents = ({
  ...
  return (
    <React.Fragment>
      {/* Mobile & Tablet */}
      <section className="bg-[#3A563E] w-full px-[21.25px] py-[14px] fixed bottom-0 flex space-x-5 overflow-x-auto scrollbar-hide md:space-x-2 md:justify-center lg:hidden">
