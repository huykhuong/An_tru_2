...
const DishesDivWrapper = (props) => {
  ...
  return (
    <motion.div
      ref={scrollRef}
      id="dishes_wrapper"
      className="bg-[#c2f4ab] bg-opacity-30 h-[calc(100vh-150.797px)] w-[100%] mx-auto mt-[86.797px] mb-[63.5px] flex flex-wrap gap-y-4 gap-x-2 content-start overflow-y-auto justify-center md:px-3 md:gap-x-5 lg:scrollbar-hide lg:overflow-x-auto lg:justify-start lg:gap-x-0 lg:px-0 lg:my-0 lg:flex-nowrap lg:h-[100vh] lg:mx-0 lg:bg-transparent"
      key={"dishes_wrapper"}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
