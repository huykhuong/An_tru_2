  ...
  return (
    <Fragment>
      ...
      <motion.main
        ...
        className="mt-40 lg:max-w-[1650px] xl:max-w-[1400px] mx-auto"
      >
        {/* TITLE */}
        ...
        <section className="mt-[300px] lg:flex lg:space-x-20 lg:justify-between">
          ...
          <div className="max-w-xs mx-auto leading-8 text-[17px] text-black text-opacity-70 md:max-w-sm grid grid-cols-2 lg:mx-0">
            ...
            <p className="border-b text-lg">32 chỗ</p>
            <p className="border-b font-bold text-lg">Đóng cửa</p>
            <p className="border-b text-lg">
              Thứ 2 hàng tuần (trừ các ngày Mùng 1 & 15 âm lịch)
            </p>
            <p className="border-b font-bold text-lg">Địa điểm</p>
            <p className="border-b text-lg">
              Lầu 1 & 2, 230 Nguyễn Sơn, Tân Phú
            </p>
            <p className="font-bold text-lg">Giờ mở cửa</p>
          ...
          <div className="max-w-xs mx-auto leading-8 text-[17px] text-black text-opacity-70 md:max-w-sm grid grid-cols-2 lg:mx-0">
            <p className="font-bold text-lg">Đặt bàn</p>
            <p className="text-lg">
