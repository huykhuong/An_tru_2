      ...
      {pageWillBeExitingFrom == "menu" && (
        ...
        >
          ...
          {selectedFilterOption === 0 &&
            <DishesDivWrapper>{mon_com.map(item => (
              <DishCard key={item.name} dishName={item.name} dishPrice={item.price} />
            ))}</DishesDivWrapper>}

          {selectedFilterOption === 1 && <DishesDivWrapper>{mon_soi.map(item => (
            <DishCard key={item.name} dishName={item.name} dishPrice={item.price} />
          ))}</DishesDivWrapper>}

          {selectedFilterOption === 2 && <DishesDivWrapper>{mon_canh.map(item => (
            <DishCard key={item.name} dishName={item.name} dishPrice={item.price} />
          ))}</DishesDivWrapper>}

          {selectedFilterOption === 3 && <DishesDivWrapper>{mon_rau.map(item => (
            <DishCard key={item.name} dishName={item.name} dishPrice={item.price} />
          ))}</DishesDivWrapper>}

          {selectedFilterOption === 4 && <DishesDivWrapper>{mon_an_kem.map(item => (
            <DishCard key={item.name} dishName={item.name} dishPrice={item.price} />
          ))}</DishesDivWrapper>}
