  ...
  return (
    <Fragment>
      ...
      <motion.main
        ...
        // onWheel={onWheel}
        className="mt-[100px] pt-10 w-[100%] h-[calc(100vh-64px)] overflow-y-scroll lg:flex lg:overflow-y-hidden lg:cursor-pointer lg:overflow-x-auto lg:mt-0 lg:scrollbar-hide lg:h-screen lg:pt-0"
      >
        <TitleAndPrice />
